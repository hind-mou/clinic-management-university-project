	...
	<body>
		<div class="container">
			...
			<div class="recherche">
					...
					<input type="text" name="user"  placeholder="username" id="fin">
...
for ($i=1; $i<=$total_pages; $i++) {  // print href pour tous les pages
			...
			<div class="ajouter">
				<div class="contenu">
					...
					<h2  id="phrase"style="font-family: Poppins-Bold;    color: #8a8a8a;margin-left: 130px;">ajouter  utilisateur</h2>
					<form action="ajouteruser.php" method="POST" class="ajouterf">
					 ...
					 <input type="text" name="prenom" required="true" placeholder="prenom">
					 <input type="text" name="user" required="true" placeholder="username">
					 <input type="text" name="pass" required="true" placeholder="mot de passe">
...
<!--===============================================================================================-->
	<script src="table/js/main.js"></script>
       ...
       document.querySelector(".ajouter").style.visibility="hidden";
            $(".ajouter").load("analyse/originalana.php",{
	  ...
	  var id=this.parentNode.id;
	  	...
	  	location.replace("infoana.php?id="+id);
           ...
           if((d=="")||(f=="")){
            ...
            $(".don").load("analyse/searchana.php",{
            	debut:d,
            	fin:f
            });
        });
