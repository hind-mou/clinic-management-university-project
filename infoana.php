...
<div class="contenu">
	<h3>Plus d'informations sur l'analyse</h3>
	<?php 
	$p=$_GET['id'];
	$id_pat=substr($p,0,3);
$date_a=substr($p, 4);
	$sql="SELECT patient.nom,patient.prenom,patient.cin,patient_analyse.date_a,analyse.libelle,analyse.prix FROM analyse,patient_analyse,patient WHERE patient_analyse.id_pat=patient.id_pat AND patient_analyse.id_ana=analyse.id_a AND patient.id_pat=$id_pat AND date(patient_analyse.date_a)='$date_a';";
	...
	<table>
		...
		<tr>
			<td style="font-weight: bold;">date analyse :</td>
			<td><?php echo $date_ana; ?></td>
		</tr>
			<tr>
