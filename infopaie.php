...
<div class="contenu">
	<h3>Plus d'informations sur le paiement</h3>
	<?php 
	$p=$_GET['id'];
	$sql="SELECT patient.nom,patient.prenom,patient.cin,rendez_vous.date_r,paiement.date_p,paiement.montant FROM rendez_vous,consultation,patient,paiement WHERE paiement.id_c=consultation.id_c AND consultation.id_r=rendez_vous.id_r AND rendez_vous.id_pat=patient.id_pat;";
	...
	<table>
		...
		<tr>
			...
			<tr>
			<td style="font-weight: bold;">date paiement :</td>
