	...
	<body>
		<div class="container">
			...
			<div class="recherche">
					...
					<input type="text" name="titre"  placeholder="titre" id="fin">
	...
	<script src="table/js/main.js"></script>
		<script>
			...
			$(document).on ("click", ".m", function () {
								$("#phrase").html("modifier medicament");

       document.querySelector(".ajouter").style.visibility="visible";
            $(".ajouterf").load("medicament/editmed.php",{
			 ...
			 // pour la suppression
			  $(document).on ("click", ".s", function () {
				...
				if (confirm("voulez-vous vraiment supprimer ce medicament?")) {
   				$(".don").load("medicament/deletem.php",{
              id:this.parentNode.id
           ...
           var t =document.querySelector("#fin").value;

           if(t==""){
           	alert("veuillez entrer le titre");
           	return;
           }
            $(".don").load("medicament/searchmed.php",{
            	titre:t
            });
        });
...
//fermer 
       ...
       document.querySelector(".ajouter").style.visibility="hidden";
            $(".ajouter").load("medicament/originalmed.php",{
			 ...
			 document.getElementById("fermer").addEventListener("click",function(){
			 					$("#phrase").html("ajouter medicament");
