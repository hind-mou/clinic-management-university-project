...
$sql="SELECT ordonnance.id_c,ordonnance.id_o from ordonnance ,consultation,rendez_vous WHERE rendez_vous.id_r=consultation.id_r AND consultation.id_c=ordonnance.id_c AND CAST(date_r AS DATE) BETWEEN  '$debut' AND '$fin'  LIMIT $start_from,8;";
