	...
	<body>
		<div class="container">
			...
			<div class="recherche">
					...
					<input type="text" name="cin" placeholder="recherche par cin" id="cin" > 
					<input type="text" name="nom"  placeholder="recherche par nom" id="nom">
			...
			<div class="ajouter">
				<div class="contenu">
					...
					<form action="ajouter.php" method="POST" class="ajouterf">
						   <div style="margin-left: 30px;" id="uname_response" ></div>


						<input type="text" name="cin" placeholder="CIN" id="cin2">
...
//fermer 
       ...
       document.querySelector(".ajouter").style.visibility="hidden";
           ...
           var ccin =document.querySelector("#cin").value;
           var nnom =document.querySelector("#nom").value; 
           if((ccin=="")&&(nnom=="")){
           	alert("veuillez entrer le nom ou cin");
           	return;
           }
            $(".don").load("search.php",{
            	cin:ccin,
	  ...
	  var id=this.parentNode.id;
	  	...
	  	location.replace("infopat.php?id="+id);

	     // $.post("infopat.php",{
	     // 	i:id
	     // },function(data){
	     // 	location.replace("infopat.php");
	     // });
      ...
      if(username != ''){
         ...
         $("#uname_response").html("");
			 ...
			 document.getElementById("fermer").addEventListener("click",function(){
			 	...
			 	document.querySelector(".ajouterf")[1].placeholder="nom";
			 	document.querySelector(".ajouterf")[2].placeholder="prenom";
			 	document.querySelector(".ajouterf")[3].value="";
			 	document.querySelector(".ajouterf")[4].placeholder="tel";
			 	document.querySelector(".ajouterf")[5].placeholder="email";
			 	document.querySelector(".ajouterf")[6].placeholder="adresse";
			 	document.querySelector(".ajouterf")[7].value="";
			 	document.querySelector(".ajouterf")[8].placeholder="tt";
			 	document.querySelector(".ajouterf")[9].placeholder="tt";
			 	document.querySelector(".ajouterf")[10].placeholder="maladies chroniques";
