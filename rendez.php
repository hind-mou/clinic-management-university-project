	...
	<script src="table/js/main.js"></script>
		<script>
			...
			$(document).ready(function(){
			 ...
			 // pour la suppression
			  $(document).on ("click", ".s", function () {
				...
				if (confirm("voulez-vous vraiment supprimer ce rendez_vous?")) {
   				$(".don").load("rendez/deleter.php",{
			...
			$(document).on ("click", ".m", function () {
				$("#phrase").html("modifier rendez_vous");
       document.querySelector(".ajouter").style.visibility="visible";
            $(".ajouterf").load("rendez/editrendez.php",{
              id:this.parentNode.id
            })
    });
			//fermer 
       ...
       document.querySelector(".ajouter").style.visibility="hidden";
            $(".ajouter").load("rendez/originalrendez.php",{
...
//pour obtenir plus d'info 
	  ...
	  var id=this.parentNode.id;
	  	...
	  	location.replace("inforendez.php?id="+id);
			 ...
			 document.getElementById("fermer").addEventListener("click",function(){
			 	// $(".edition").remove();
			 	// $(".ajouterf").load($(".origin"));
			 					$("#phrase").html("ajouter rendez_vous");
