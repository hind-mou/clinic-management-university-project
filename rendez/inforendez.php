					...
					<nav class="gn-menu-wrapper">
						<div class="gn-scroller">
							<ul class="gn-menu">
								...
								<?php 
								if($_SESSION["user"]==2){
									echo "<li><a class='gn-icon gn-icon-help' href='analyse.php'>analyse</a></li>";
								}else{
									echo "<li><a class='gn-icon gn-icon-cog'href='ordonnance.php'>Ordonnances</a></li>
...
<div class="contenu">
	<h3>Plus d'information sur le rendez_vous</h3>
	<?php 
	$p=$_GET['id'];
	$sql="SELECT * FROM rendez_vous WHERE id_r=$p;";
	...
	$sql="SELECT nom,prenom,tel,cin FROM patient WHERE id_pat=$id_pat;";
	$resultat=mysqli_query($conn,$sql);
	while($r=mysqli_fetch_assoc($resultat)){
		$nom=$r['nom'];
		$prenom=$r['prenom'];
